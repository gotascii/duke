...
Duke, the Real American Hero, led GIJoes into battle. Duke.rb leads your CIJoes into battle. In other words, Duke helps you manage multiple CIJoe instances. It comes with a command-line interface and a web interface.
...
=== Default Configuration
  ...
  host: localhost
Given a cijoe running on port 4567 and configured host of 'localhost' the cijoe url will be http://localhost:4567/
  runner: rake
